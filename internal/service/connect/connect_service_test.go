...
import (
	...
	"github.com/312022151125/coli/internal/test/mocks/commonmock"
	"github.com/312022151125/coli/internal/test/mocks/connectmock"
	"github.com/312022151125/coli/internal/test/mocks/kvmock"
	"github.com/312022151125/coli/internal/test/mocks/txmock"
...
func TestGetConnect_LogoDerivation(t *testing.T) {
	cases := []struct {
		...
		{"empty logo falls back to default", "https://ech0.app", "", "https://ech0.app/timeline-mark.svg"},
		{"Ech0.svg sentinel falls back to default", "https://ech0.app", "Ech0.svg", "https://ech0.app/timeline-mark.svg"},
		{"/Ech0.svg sentinel falls back to default", "https://ech0.app", "/Ech0.svg", "https://ech0.app/timeline-mark.svg"},
		{"trailing slash on server url is trimmed", "https://ech0.app/", "", "https://ech0.app/timeline-mark.svg"},
